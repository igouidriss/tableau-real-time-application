package com.sbm.tableaurealtime.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.sbm.tableaurealtime.service.EmailAlreadyUsedException ||
            ex instanceof com.sbm.tableaurealtime.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.sbm.tableaurealtime.service.InvalidPasswordException
